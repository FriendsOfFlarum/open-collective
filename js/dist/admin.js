...
app.initializers.add('fof/open-collective', function () {
  app.extensionSettings['fof-open-collective'] = function () {
    return app.modal.show(SettingsModal, {
      ...
      items: function items(e) {
        return [m("p", null, app.translator.trans('fof-open-collective.admin.settings.desc', {
          a: m("a", {
            href: "https://opencollective.com/applications",
            target: "_blank"
          })
        })), m(StringItem, {
          setting: e,
          name: "fof-open-collective.api_key",
          required: true,
          type: "password"
        }, app.translator.trans('fof-open-collective.admin.settings.api_key_label')), m(StringItem, {
          setting: e,
          name: "fof-open-collective.slug",
          required: true
        }, app.translator.trans('fof-open-collective.admin.settings.slug_label')), m("div", {
          className: "Form-group"
        }, m("label", null, app.translator.trans('fof-open-collective.admin.settings.group_label')), SelectItem.component({
